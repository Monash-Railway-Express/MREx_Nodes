...
## [2.1.0] - 28-04-26 - Nhan Nguyen
## Added
- Dual serial module

## [2.0.2] - 20-04-26 - Chiara Gillam
### Changed
- autostop doesnt restart once finished
- can autstop multiple times

## Added 
- Service brake can be applied from mc node
